...
type ThumbupRequest struct {
	...
	ObjId    string `protobuf:"bytes,2,opt,name=objId,proto3" json:"objId,omitempty"`        // 点赞对象id
...
func (x *ThumbupRequest) GetObjId() string {
	if x != nil {
		return x.ObjId
	}
	return ""
...
func (x *ThumbupResponse) GetObjId() string {
	if x != nil {
		return x.ObjId
	}
	return ""
...
type IsThumbupRequest struct {
	...
	BizId    string `protobuf:"bytes,1,opt,name=bizId,proto3" json:"bizId,omitempty"`       // 业务id
	TargetId string `protobuf:"bytes,2,opt,name=targetId,proto3" json:"targetId,omitempty"` // 点赞对象id
	UserId   string `protobuf:"bytes,3,opt,name=userId,proto3" json:"userId,omitempty"`     // 用户id
}
...
func (x *IsThumbupRequest) GetTargetId() string {
	if x != nil {
		return x.TargetId
	}
	return ""
...
func (x *IsThumbupRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
type IsThumbupResponse struct {
	...
	UserThumbups map[string]*UserThumbup `protobuf:"bytes,1,rep,name=userThumbups,proto3" json:"userThumbups,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *IsThumbupResponse) GetUserThumbups() map[string]*UserThumbup {
	if x != nil {
...
func (x *UserThumbup) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
var file_like_proto_rawDesc = []byte{
	...
	0x12, 0x14, 0x0a, 0x05, 0x6f, 0x62, 0x6a, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0xbc,
	...
	0x70, 0x65, 0x32, 0x88, 0x01, 0x0a, 0x04, 0x6c, 0x69, 0x6b, 0x65, 0x12, 0x3c, 0x0a, 0x07, 0x54,
