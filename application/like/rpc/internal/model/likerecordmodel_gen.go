...
type (
	likeRecordModel interface {
		...
		FindOne(ctx context.Context, id string) (*LikeRecord, error)
		FindOneByBizIdObjIdUserId(ctx context.Context, bizId string, objId string, userId string) (*LikeRecord, error)
...
func (m *defaultLikeRecordModel) Delete(ctx context.Context, id string) error {
	query := fmt.Sprintf("delete from %s where `id` = ?", m.table)
	_, err := m.conn.ExecCtx(ctx, query, id)
	return err
}

func (m *defaultLikeRecordModel) FindOne(ctx context.Context, id string) (*LikeRecord, error) {
...
func (m *defaultLikeRecordModel) FindOneByBizIdObjIdUserId(ctx context.Context, bizId string, objId string, userId string) (*LikeRecord, error) {
	var resp LikeRecord
...
func (m *defaultLikeRecordModel) Insert(ctx context.Context, data *LikeRecord) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.Id, data.BizId, data.ObjId, data.UserId, data.LikeType)
	return ret, err
}
