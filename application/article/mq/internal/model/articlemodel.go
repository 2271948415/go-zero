...
type (
	...
	ArticleModel interface {
		articleModel
		UpdateLikeNum(ctx context.Context, id string, likeNum int64) error
	}
...
func (m *customArticleModel) UpdateLikeNum(ctx context.Context, id string, likeNum int64) error {
